    ...
    <div className="flex h-full flex-col px-3 py-4 md:px-2">
      ...
      <div className="flex grow flex-row justify-between space-x-2 md:flex-col md:space-x-0 md:space-y-2">
        ...
        <button
          ...
          className="p-3 text-sm text-white flex h-[48px] w-full grow items-center justify-center gap-2 rounded-md border border-black hover:border-neutral-700 font-medium hover:bg-neutral-800/30 hover:text-yellow-500 md:flex-none md:justify-start md:p-2 md:px-3"
        >
