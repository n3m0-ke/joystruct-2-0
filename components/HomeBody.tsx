        ...
        <div className="container mx-auto px-6 py-24 text-white" data-aos="fade-up">
            <div className="max-w-2xl">
                <h1 className="text-4xl md:text-6xl font-heading font-bold mb-6">
                    ...
                    {/* Innovative Structural Design, Built to Last */}
                </h1>
                ...
                <div className="flex space-x-4">
                    ...
                    <a href="#projects" className="border-2 border-white hover:bg-white hover:text-teal-600 text-white px-8 py-3 rounded-md font-medium transition duration-300">View Projects</a>
                </div>
            </div>
        </div>
