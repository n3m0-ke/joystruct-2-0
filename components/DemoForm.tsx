...
export function DemoForm() {
    return (
        <div className="flex flex-col items-end gap-6 min-w-max mx-auto">
            <form className="mt-8 mx-auto content-center">
                <div className="mb-1 flex flex-col gap-6">
                    ...
                    <div className="flex flex-row w-96 ">
                        <div className="flex w-48 flex-col gap-6">
                            <div className="relative">
                                <input type="text" id="company_name" className="block rounded-t-lg px-2.5 pb-2.5 pt-5 w-full text-sm bg-transparent border-0 border-b-2 border-purple-400 appearance-no text-white focus:outline-none focus:ring-0 focus:border-purple-600 focus:ring-purple-600 peer" placeholder=" " />
                                <label htmlFor="company_name" className="absolute text-sm text-purple-400 duration-300 transform -translate-y-4 scale-75 top-4 z-10 origin-[0] start-2.5 peer-focus:text-purple-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto">Company Name</label>
                            </div>
                        </div>
                        <div className="flex w-48 flex-col gap-6">
                            <div className="relative">
                                <input type="text" id="position" className="block rounded-t-lg px-2.5 pb-2.5 pt-5 w-full text-sm bg-transparent border-0 border-b-2 border-purple-400 appearance-no text-white focus:outline-none focus:ring-0 focus:border-purple-600 focus:ring-purple-600 peer" placeholder=" " />
